...
verts = np.load("6D_TORUS_POINT_CLOUD.npy")
...
np.save("6D_TORUS_DELAUNAY_SIMPLICES.npy", arr = T)
np.save("6D_TORUS_DELAUNAY_POINTS.npy", arr = V)


with open("6D_TORUS_OBJ_FILE.obj", "w") as f:
